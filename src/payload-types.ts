...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'component-registry': ComponentRegistrySelect<false> | ComponentRegistrySelect<true>;
  ...
  globalsSelect: {
    ...
    whatsappSettings: WhatsappSettingsSelect<false> | WhatsappSettingsSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'fiftyFifty' | 'heroCollage';
    usps?:
      | {
          usp: string;
          icon?:
    ...
    links?:
      | {
          link: {
             ...
             */
            appearance?: ('default' | 'outline' | 'cta') | null;
          };
          id?: string | null;
        }[]
      | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SuitableApplicationsBlock".
 */
export interface SuitableApplicationsBlock {
  title: string;
  richText?: {
    root: {
      type: string;
...
export interface ProcessBlock {
  ...
  steps: {
    ...
    description: string;
    /**
     * Hex color for the number square. Defaults to black.
     */
    color?: string | null;
    media?: (number | null) | Media;
    id?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CardsCarouselBlock".
 */
export interface CardsCarouselBlock {
  title?: string | null;
  cards: {
    link?: {
      type?: ('reference' | 'custom') | null;
...
export interface ReviewsBlock {
  title: string;
  /**
   * Enter the Google Place ID for your business to fetch the overall rating and review count.
   */
  googlePlaceId: string;
  /**
   * Rating to show if Google API is unavailable (1-5)
   */
  fallbackRating?: number | null;
  /**
   * Description to show if Google API is unavailable
   */
  fallbackDescription?: string | null;
  /**
   * Toggle to enable/disable fetching overall rating from Google Places API
   */
  enableGoogleRating?: boolean | null;
  /**
   * Individual review cards displayed on the right side
   */
  reviews?:
    | {
        reviewerName: string;
...
export interface Site {
  ...
  siteName: string;
  /**
   * URL-friendly identifier (e.g., my-awesome-site)
   */
  slug: string;
  theme?: {
    /**
    ...
    fontFamily?: ('inter' | 'geist' | 'roboto') | null;
  };
  headerConfig?: {
    headerType?: ('default' | 'centered' | 'minimal') | null;
    /**
  ...
  heroConfig: {
    heroType: 'highImpact' | 'fiftyFifty' | 'heroCollage' | 'none';
    /**
     * Hero configuration data (title, subtitle, CTA, etc.)
     */
    heroData?:
      | {
          [k: string]: unknown;
  ...
  selectedBlocks?:
    ...
    | null;
  deploymentStatus?: ('draft' | 'creating-repo' | 'configuring' | 'deploying' | 'deployed' | 'failed') | null;
...
/**
 * Registry of all available blocks and components for the website builder
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "component-registry".
 */
export interface ComponentRegistry {
  id: number;
  /**
   * Unique identifier for this component (e.g., call-to-action)
   */
  name: string;
  /**
  ...
  description?: string | null;
  /**
   * Category for organizing components in the builder
   */
  category:
    | 'hero'
    | 'content'
    ...
    | 'other';
  /**
   * Whether this is a built-in block or from npm
   */
  source: 'builtin' | 'npm';
  /**
   * The blockType slug used in Payload config (e.g., cta, feature)
   */
  blockType: string;
  /**
   * NPM package name (e.g., @huce-digital/sample-block)
   */
  npmPackage?: string | null;
  /**
   * Import path for the component (e.g., @/blocks/CallToAction/Component)
   */
  importPath: string;
  /**
   * Import path for the Payload config (e.g., @/blocks/CallToAction/config)
   */
  configImportPath: string;
  /**
   * Preview thumbnail for the builder UI
   */
  previewImage?: (number | null) | Media;
  /**
   * Default configuration when adding this block (JSON format)
   */
  defaultConfig?:
    | {
        [k: string]: unknown;
  ...
  configSchema?:
    ...
    | null;
  /**
   * Whether this component is available in the builder
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'component-registry';
        value: number | ComponentRegistry;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SuitableApplicationsBlock_select".
 */
export interface SuitableApplicationsBlockSelect<T extends boolean = true> {
  title?: T;
  richText?: T;
  applications?:
    | T
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CardsCarouselBlock_select".
 */
export interface CardsCarouselBlockSelect<T extends boolean = true> {
  title?: T;
  cards?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TeamSection_select".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "component-registry_select".
 */
export interface ComponentRegistrySelect<T extends boolean = true> {
  name?: T;
  displayName?: T;
  description?: T;
  category?: T;
...
export interface Header {
  id: number;
  /**
   * Controls the small top bar above navigation.
   */
  topBar?: {
  ...
  navItems?:
    | {
        type?: ('link' | 'dropdown' | 'button') | null;
        label?: string | null;
        link: {
          type?: ('reference' | 'custom') | null;
          newTab?: boolean | null;
...
export interface Footer {
  ...
  socials?:
    | {
        social?: ('Instagram' | 'Facebook' | 'Linkedin' | 'Youtube' | 'Tiktok') | null;
        link?: string | null;
        id?: string | null;
      }[]
    | null;
  timeTable?:
    | {
        day?: ('maandag' | 'dinsdag' | 'woensdag' | 'donderdag' | 'vrijdag' | 'zaterdag' | 'zondag') | null;
        availability?: ('open' | 'gesloten' | 'op afspraak') | null;
 ...
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "whatsappSettings".
 */
export interface WhatsappSetting {
  id: number;
  /**
   * Enable or disable the entire WhatsApp integration
   */
  enabled?: boolean | null;
  /**
  ...
  phoneNumber: string;
  /**
   * Configure the WhatsApp popup appearance and behavior
   */
  popupSettings?: {
    /**
     * Show the WhatsApp popup on page load
     */
    enabled?: boolean | null;
    /**
    ...
    /**
     * Company name shown in the popup
     */
    companyName?: string | null;
    /**
     * Greeting message in the popup
     */
    greeting?: string | null;
    /**
     * Main message shown in the popup
     */
    message?: string | null;
    /**
  ...
  /**
   * Configure the floating WhatsApp button
   */
  buttonSettings?: {
    /**
     * Default message when clicking the WhatsApp button
     */
    message?: string | null;
  };
  updatedAt?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "whatsappSettings_select".
 */
