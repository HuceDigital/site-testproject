...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.run(sql`CREATE TABLE \`pages_hero_usps\` (
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_hero_usps_order_idx\` ON \`pages_hero_usps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_hero_usps_parent_id_idx\` ON \`pages_hero_usps\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_hero_collage_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_hero_collage_images_order_idx\` ON \`pages_hero_collage_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_hero_collage_images_parent_id_idx\` ON \`pages_hero_collage_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_hero_collage_images_image_idx\` ON \`pages_hero_collage_images\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_archive\` (
  	...
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`intro_content\` text,
  	\`with_filter\` integer DEFAULT false,
  	\`show_view_all_link\` integer DEFAULT false,
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_contentsection\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_contentsection_order_idx\` ON \`pages_blocks_contentsection\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_contentsection_parent_id_idx\` ON \`pages_blocks_contentsection\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_contentsection_path_idx\` ON \`pages_blocks_contentsection\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_suitableapplications_applications\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`icon\` text DEFAULT 'Check',
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_suitableapplications\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_suitableapplications_applications_order_idx\` ON \`pages_blocks_suitableapplications_applications\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_suitableapplications_applications_parent_id_idx\` ON \`pages_blocks_suitableapplications_applications\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_suitableapplications\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_suitableapplications_order_idx\` ON \`pages_blocks_suitableapplications\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_suitableapplications_parent_id_idx\` ON \`pages_blocks_suitableapplications\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_suitableapplications_path_idx\` ON \`pages_blocks_suitableapplications\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_faq_questions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`question\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_questions_order_idx\` ON \`pages_blocks_faq_questions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_faq_questions_parent_id_idx\` ON \`pages_blocks_faq_questions\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_process_steps_media_idx\` ON \`pages_blocks_process_steps\` (\`media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_feature_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_features_order_idx\` ON \`pages_blocks_feature_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_features_parent_id_idx\` ON \`pages_blocks_feature_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_feature\` (
  	...
  	FOREIGN KEY (\`left_media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`right_media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_background_image_idx\` ON \`pages_blocks_feature\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_left_media_idx\` ON \`pages_blocks_feature\` (\`left_media_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_right_media_idx\` ON \`pages_blocks_feature\` (\`right_media_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_text_with_image\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_with_image_order_idx\` ON \`pages_blocks_text_with_image\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_with_image_parent_id_idx\` ON \`pages_blocks_text_with_image\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_with_image_path_idx\` ON \`pages_blocks_text_with_image\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_text_with_image_media_idx\` ON \`pages_blocks_text_with_image\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_cards_carousel_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  	...
  	\`image_id\` integer,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_cards_carousel\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_cards_order_idx\` ON \`pages_blocks_cards_carousel_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_cards_parent_id_idx\` ON \`pages_blocks_cards_carousel_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_cards_image_idx\` ON \`pages_blocks_cards_carousel_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_cards_carousel\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_order_idx\` ON \`pages_blocks_cards_carousel\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_parent_id_idx\` ON \`pages_blocks_cards_carousel\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cards_carousel_path_idx\` ON \`pages_blocks_cards_carousel\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_marquee_logos\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`logo_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_marquee_logos_order_idx\` ON \`pages_blocks_marquee_logos\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_marquee_logos_parent_id_idx\` ON \`pages_blocks_marquee_logos\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_marquee_logos_logo_idx\` ON \`pages_blocks_marquee_logos\` (\`logo_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_image_carousel_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	\`caption\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_image_carousel\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_images_order_idx\` ON \`pages_blocks_image_carousel_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_images_parent_id_idx\` ON \`pages_blocks_image_carousel_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_images_image_idx\` ON \`pages_blocks_image_carousel_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_image_carousel\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_order_idx\` ON \`pages_blocks_image_carousel\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_parent_id_idx\` ON \`pages_blocks_image_carousel\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_image_carousel_path_idx\` ON \`pages_blocks_image_carousel\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_team_section_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text,
  	\`label\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_team_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_stats_order_idx\` ON \`pages_blocks_team_section_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_stats_parent_id_idx\` ON \`pages_blocks_team_section_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_team_section_members\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_members_order_idx\` ON \`pages_blocks_team_section_members\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_members_parent_id_idx\` ON \`pages_blocks_team_section_members\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_team_section_members_image_idx\` ON \`pages_blocks_team_section_members\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_team_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text DEFAULT 'Ons team',
  	\`intro\` text,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_reviews_reviews\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`reviewer_name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_reviews_reviews_order_idx\` ON \`pages_blocks_reviews_reviews\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_reviews_reviews_parent_id_idx\` ON \`pages_blocks_reviews_reviews\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_reviews\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text DEFAULT 'Reviews van anderen',
  	\`google_place_id\` text,
  	\`fallback_rating\` numeric DEFAULT 4.5,
  	\`fallback_description\` text DEFAULT 'Based on customer reviews',
  	\`enable_google_rating\` integer DEFAULT true,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_reviews_order_idx\` ON \`pages_blocks_reviews\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_reviews_parent_id_idx\` ON \`pages_blocks_reviews\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_reviews_path_idx\` ON \`pages_blocks_reviews\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages\` (
  	...
  	\`hero_sub_content_title\` text,
  	\`hero_sub_content_description\` text,
  	\`hero_sub_content_image_id\` integer,
  	\`hero_sub_content_image_position\` text,
  	\`meta_title\` text,
  	...
  	FOREIGN KEY (\`hero_sub_content_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_hero_hero_logo_idx\` ON \`pages\` (\`hero_logo_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_hero_hero_media_idx\` ON \`pages\` (\`hero_media_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_hero_sub_content_hero_sub_content_image_idx\` ON \`pages\` (\`hero_sub_content_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_version_hero_usps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`usp\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_usps_order_idx\` ON \`_pages_v_version_hero_usps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_usps_parent_id_idx\` ON \`_pages_v_version_hero_usps\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_version_hero_collage_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_collage_images_order_idx\` ON \`_pages_v_version_hero_collage_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_collage_images_parent_id_idx\` ON \`_pages_v_version_hero_collage_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_collage_images_image_idx\` ON \`_pages_v_version_hero_collage_images\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_contentsection\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_contentsection_order_idx\` ON \`_pages_v_blocks_contentsection\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_contentsection_parent_id_idx\` ON \`_pages_v_blocks_contentsection\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_contentsection_path_idx\` ON \`_pages_v_blocks_contentsection\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_suitableapplications_applications\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`icon\` text DEFAULT 'Check',
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_suitableapplications\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_suitableapplications_applications_order_idx\` ON \`_pages_v_blocks_suitableapplications_applications\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_suitableapplications_applications_parent_id_idx\` ON \`_pages_v_blocks_suitableapplications_applications\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_suitableapplications\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_suitableapplications_order_idx\` ON \`_pages_v_blocks_suitableapplications\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_suitableapplications_parent_id_idx\` ON \`_pages_v_blocks_suitableapplications\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_suitableapplications_path_idx\` ON \`_pages_v_blocks_suitableapplications\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_faq_questions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`question\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_questions_order_idx\` ON \`_pages_v_blocks_faq_questions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_faq_questions_parent_id_idx\` ON \`_pages_v_blocks_faq_questions\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_process_steps_media_idx\` ON \`_pages_v_blocks_process_steps\` (\`media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_feature_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_features_order_idx\` ON \`_pages_v_blocks_feature_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_features_parent_id_idx\` ON \`_pages_v_blocks_feature_features\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_background_image_idx\` ON \`_pages_v_blocks_feature\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_left_media_idx\` ON \`_pages_v_blocks_feature\` (\`left_media_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_right_media_idx\` ON \`_pages_v_blocks_feature\` (\`right_media_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_text_with_image\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_text_with_image_order_idx\` ON \`_pages_v_blocks_text_with_image\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_text_with_image_parent_id_idx\` ON \`_pages_v_blocks_text_with_image\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_text_with_image_path_idx\` ON \`_pages_v_blocks_text_with_image\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_text_with_image_media_idx\` ON \`_pages_v_blocks_text_with_image\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_cards_carousel_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_cards_carousel\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_cards_order_idx\` ON \`_pages_v_blocks_cards_carousel_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_cards_parent_id_idx\` ON \`_pages_v_blocks_cards_carousel_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_cards_image_idx\` ON \`_pages_v_blocks_cards_carousel_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_cards_carousel\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_order_idx\` ON \`_pages_v_blocks_cards_carousel\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_parent_id_idx\` ON \`_pages_v_blocks_cards_carousel\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cards_carousel_path_idx\` ON \`_pages_v_blocks_cards_carousel\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_marquee_logos\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`logo_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_marquee_logos_order_idx\` ON \`_pages_v_blocks_marquee_logos\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_marquee_logos_parent_id_idx\` ON \`_pages_v_blocks_marquee_logos\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_marquee_logos_logo_idx\` ON \`_pages_v_blocks_marquee_logos\` (\`logo_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_image_carousel_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_image_carousel\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_images_order_idx\` ON \`_pages_v_blocks_image_carousel_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_images_parent_id_idx\` ON \`_pages_v_blocks_image_carousel_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_images_image_idx\` ON \`_pages_v_blocks_image_carousel_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_image_carousel\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_order_idx\` ON \`_pages_v_blocks_image_carousel\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_parent_id_idx\` ON \`_pages_v_blocks_image_carousel\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_image_carousel_path_idx\` ON \`_pages_v_blocks_image_carousel\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_team_section_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`value\` text,
  	\`label\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_team_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_stats_order_idx\` ON \`_pages_v_blocks_team_section_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_stats_parent_id_idx\` ON \`_pages_v_blocks_team_section_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_team_section_members\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_members_order_idx\` ON \`_pages_v_blocks_team_section_members\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_members_parent_id_idx\` ON \`_pages_v_blocks_team_section_members\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_members_image_idx\` ON \`_pages_v_blocks_team_section_members\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_team_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_order_idx\` ON \`_pages_v_blocks_team_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_parent_id_idx\` ON \`_pages_v_blocks_team_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_team_section_path_idx\` ON \`_pages_v_blocks_team_section\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_reviews_reviews\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`reviewer_name\` text,
  	...
  	\`rating\` numeric DEFAULT 5,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_reviews\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_reviews_reviews_order_idx\` ON \`_pages_v_blocks_reviews_reviews\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_reviews_reviews_parent_id_idx\` ON \`_pages_v_blocks_reviews_reviews\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_reviews\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_reviews_order_idx\` ON \`_pages_v_blocks_reviews\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_reviews_parent_id_idx\` ON \`_pages_v_blocks_reviews\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_reviews_path_idx\` ON \`_pages_v_blocks_reviews\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v\` (
  	...
  	\`version_hero_sub_content_title\` text,
  	\`version_hero_sub_content_description\` text,
  	\`version_hero_sub_content_image_id\` integer,
  	\`version_hero_sub_content_image_position\` text,
  	...
  	FOREIGN KEY (\`version_hero_logo_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_hero_media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_hero_sub_content_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_parent_idx\` ON \`_pages_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_version_hero_logo_idx\` ON \`_pages_v\` (\`version_hero_logo_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_version_hero_media_idx\` ON \`_pages_v\` (\`version_hero_media_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_hero_sub_content_version_hero_sub_conte_idx\` ON \`_pages_v\` (\`version_hero_sub_content_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`projects_gallery_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`projects_gallery_images_order_idx\` ON \`projects_gallery_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`projects_gallery_images_parent_id_idx\` ON \`projects_gallery_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`projects_gallery_images_image_idx\` ON \`projects_gallery_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`projects_populated_authors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`projects_populated_authors_order_idx\` ON \`projects_populated_authors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`projects_populated_authors_parent_id_idx\` ON \`projects_populated_authors\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`projects_before_image_idx\` ON \`projects\` (\`before_image_id\`);`)
  await db.run(sql`CREATE INDEX \`projects_after_image_idx\` ON \`projects\` (\`after_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_projects_v_version_gallery_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_projects_v_version_gallery_images_order_idx\` ON \`_projects_v_version_gallery_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_projects_v_version_gallery_images_parent_id_idx\` ON \`_projects_v_version_gallery_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_projects_v_version_gallery_images_image_idx\` ON \`_projects_v_version_gallery_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_projects_v_version_populated_authors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_uuid\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_projects_v_version_populated_authors_order_idx\` ON \`_projects_v_version_populated_authors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_projects_v_version_populated_authors_parent_id_idx\` ON \`_projects_v_version_populated_authors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_projects_v\` (
  	...
  	\`version_hero_image_id\` integer,
  	\`version_content\` text,
  	\`version_display_mode\` text DEFAULT 'grid',
  	...
  	FOREIGN KEY (\`version_hero_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_before_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_after_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  ...
  await db.run(sql`CREATE INDEX \`_projects_v_version_version_before_image_idx\` ON \`_projects_v\` (\`version_before_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_projects_v_version_version_after_image_idx\` ON \`_projects_v\` (\`version_after_image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_projects_v_rels_users_id_idx\` ON \`_projects_v_rels\` (\`users_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`forms\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`form_variant\` text DEFAULT 'googleMaps' NOT NULL,
  	\`title\` text NOT NULL,
  ...
  await db.run(sql`CREATE INDEX \`header_rels_projects_id_idx\` ON \`header_rels\` (\`projects_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`footer_time_table\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`day\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`footer_time_table_order_idx\` ON \`footer_time_table\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_time_table_parent_id_idx\` ON \`footer_time_table\` (\`_parent_id\`);`)
  await db.run(sql`CREATE UNIQUE INDEX \`footer_time_table_day_idx\` ON \`footer_time_table\` (\`day\`);`)
  ...
  await db.run(sql`CREATE TABLE \`footer\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`google_reviews\` numeric DEFAULT 4.5,
  	\`contact_phone\` text,
  	\`contact_email\` text,
  	\`contact_kvk\` text,
  	\`media_id\` integer,
  	...
  	\`created_at\` text,
  	FOREIGN KEY (\`media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`media_right_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`footer_media_idx\` ON \`footer\` (\`media_id\`);`)
  await db.run(sql`CREATE INDEX \`footer_media_right_idx\` ON \`footer\` (\`media_right_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`footer_rels_projects_id_idx\` ON \`footer_rels\` (\`projects_id\`);`)
  await db.run(sql`CREATE TABLE \`whatsapp_settings\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`enabled\` integer DEFAULT true,
  	\`phone_number\` text NOT NULL,
  	\`popup_settings_enabled\` integer DEFAULT true,
  	\`popup_settings_delay\` numeric DEFAULT 3,
  	\`popup_settings_disable_on_mobile\` integer DEFAULT false,
  	\`popup_settings_sender_name\` text DEFAULT 'Pierre',
  	\`popup_settings_company_name\` text DEFAULT 'van Huce Digital',
  	\`popup_settings_greeting\` text DEFAULT 'Goedenavond',
  	\`popup_settings_message\` text DEFAULT 'Heb je een vraag? Ik help je graag verder via:',
  	\`popup_settings_avatar_image_id\` integer,
  	\`button_settings_message\` text DEFAULT 'Hallo! Ik heb een vraag over jullie diensten.',
  	\`updated_at\` text,
  	\`created_at\` text,
  	FOREIGN KEY (\`popup_settings_avatar_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`whatsapp_settings_popup_settings_popup_settings_avatar_i_idx\` ON \`whatsapp_settings\` (\`popup_settings_avatar_image_id\`);`)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.run(sql`DROP TABLE \`pages_hero_usps\`;`)
  await db.run(sql`DROP TABLE \`pages_hero_links\`;`)
  await db.run(sql`DROP TABLE \`pages_hero_collage_images\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_contentsection\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_suitableapplications_applications\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_suitableapplications\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_faq_questions\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_feature_features\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_feature\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_text_with_image\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_cards_carousel_cards\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_cards_carousel\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_marquee_logos\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_marquee\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_image_carousel_images\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_image_carousel\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_team_section_stats\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_team_section_members\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_team_section\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_reviews_reviews\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_reviews\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`DROP TABLE \`pages_rels\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_version_hero_usps\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_version_hero_links\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_version_hero_collage_images\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_contentsection\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_suitableapplications_applications\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_suitableapplications\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_faq_questions\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_feature_features\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_feature\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_text_with_image\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cards_carousel_cards\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cards_carousel\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_marquee_logos\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_marquee\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_image_carousel_images\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_image_carousel\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_team_section_stats\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_team_section_members\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_team_section\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_reviews_reviews\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_reviews\`;`)
  ...
  await db.run(sql`DROP TABLE \`projects_gallery_images\`;`)
  await db.run(sql`DROP TABLE \`projects_populated_authors\`;`)
  await db.run(sql`DROP TABLE \`projects\`;`)
  await db.run(sql`DROP TABLE \`projects_rels\`;`)
  await db.run(sql`DROP TABLE \`_projects_v_version_gallery_images\`;`)
  await db.run(sql`DROP TABLE \`_projects_v_version_populated_authors\`;`)
  ...
  await db.run(sql`DROP TABLE \`footer_time_table\`;`)
  await db.run(sql`DROP TABLE \`footer_nav_items\`;`)
  await db.run(sql`DROP TABLE \`footer\`;`)
  await db.run(sql`DROP TABLE \`footer_rels\`;`)
  await db.run(sql`DROP TABLE \`whatsapp_settings\`;`)
}
