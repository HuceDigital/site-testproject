...
const generateTitle: GenerateTitle<Post | Page> = ({ doc }) => {
  return doc?.title ? `${doc.title} | Elanto` : "Elanto";
};
      ...
      fields: ({ defaultFields }) => {
        const variantField: Field = {
          ...
          options: [
            ...
            { label: "Google Maps Integrated", value: "googleMaps" },
          ],
          admin: {
            description:
        ...
        // Ensure our field appears at the top, before Title
        return [variantField, ...mapped];
      },
    },
  }),
  searchPlugin({
